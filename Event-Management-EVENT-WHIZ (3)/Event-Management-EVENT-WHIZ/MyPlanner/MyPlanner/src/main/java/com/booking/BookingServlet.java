...
public class BookingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isTrue==true) {
			...
			request.setAttribute("bookingDetails", bookingDetails);//What is sent if redirected to JSP
			
			RequestDispatcher dis=request.getRequestDispatcher("viewbooking.jsp");//Give the page what want to navigate from the servlet
