...
<% 
    ...
    <div id="hotel-error" class="text-danger"></div>
</div> 
            <div class="form-group">
...
<footer>
  ...
  <center>
    ...
    hotelInput.addEventListener('input', function () {
        ...
        const inputValue = hotelInput.value.trim();

        if (inputValue.length < 3) {
            hotelError.textContent = 'Hotel name must be at least 3 characters long.';
            hotelInput.setCustomValidity('Hotel name must be at least 3 characters long.');
        } else {
